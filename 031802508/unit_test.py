...
class test_main(unittest.TestCase):
    ...
    def test_nowords(self):
        print("正在进行空文本异常检测")
        main_test.main_solve('sim_0.8\orig.txt', 'sim_0.8\orig_nowords.txt', 'ans.txt')
    '''
    def test_mydata0(self):
        print("正在进行mydata_hair的文本相似度检测")
        main_test.main_solve('sim_0.8\mydata_hair0.txt', 'sim_0.8\mydata_hair1.txt', 'ans.txt')

    def test_mydata1(self):
        print("正在进行mydata的文本相似度检测")
        main_test.main_solve('sim_0.8\mydata_0.txt', 'sim_0.8\mydata_1.txt', 'ans.txt')
